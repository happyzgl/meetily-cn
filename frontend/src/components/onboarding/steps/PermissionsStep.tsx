...
export function PermissionsStep() {
  ...
  const handleMicrophoneAction = async () => {
    if (permissions.microphone === 'denied') {
      ...
      try {
        ...
        alert(t('onboarding.openMicSettings'));
      }
      return;
    }
  ...
  const handleSystemAudioAction = async () => {
    if (permissions.systemAudio === 'denied') {
      ...
      try {
        ...
        alert(t('onboarding.openScreenRecordingSettings'));
      }
      return;
    }
  ...
  return (
    <OnboardingContainer
      ...
      description={t('onboarding.permissionsSubtitle')}
      step={4}
      hideProgress={true}
      ...
      <div className="max-w-lg mx-auto space-y-6">
        ...
        <div className="space-y-4">
          ...
          <PermissionRow
            ...
            title={t('onboarding.microphonePermission')}
            description={t('onboarding.microphonePermissionDesc')}
          ...
          <PermissionRow
            ...
            title={t('onboarding.screenRecording')}
            description={t('onboarding.screenRecordingDesc')}
        ...
        <div className="flex flex-col gap-3 pt-4">
          ...
          >
            {t('onboarding.illDoThisLater')}
          </button>

          {!allPermissionsGranted && (
            <p className="text-xs text-center text-muted-foreground">
              {t('recording.permissionRequiredMsg')}
            </p>
          )}
        </div>
      </div>
