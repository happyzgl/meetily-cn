...
export function PreferenceSettings() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600">{t('preferences.notificationsDesc')}</p>
          </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">{t('preferences.dataStorage')}</h3>
        ...
        <div className="space-y-4">
          ...
          {/* Recordings Location */}
          <div className="p-4 border rounded-lg bg-gray-50">
            <div className="font-medium mb-2">{t('sidebar.meetingRecordings')}</div>
            <div className="text-sm text-gray-600 mb-3 break-all font-mono text-xs">
        ...
        <div className="mt-4 p-3 bg-blue-50 rounded-md">
          <p className="text-xs text-blue-800">
            <strong>{t('common.note')}:</strong> {t('misc.databaseAndModelsTogether')}
          </p>
        </div>
      </div>
